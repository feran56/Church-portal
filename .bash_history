...
./ngrok http 5000
rm -rf ~/.ngrok2
./ngrok config add-authtoken 3EFmM83t0nkzS5WQsMZWxqsRU5I_56rPBFzTpTAV1JjrW1Jkq
...
nano app.py
python app.py
grep -R "calculator" templates
grep -R "=" templates
grep -R "function" templates | grep -i ca
nano templates/finance_category.html
grep -n "forgot" templates/base.html
nano templates/base.html
python app.py
nano templates/base.html
python app.py
